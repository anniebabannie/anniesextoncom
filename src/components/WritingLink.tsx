  ...
  function render() {
    return(
      <div className="md:flex md:flex-col gap-10">
        <a href={src} className="bg-white rounded-md shadow-md p-5 block mb-10 md:mb-0 md:flex md:gap-10 md:items-center hover:shadow-lg transition-all hover:-translate-y-1.5 hover:bg-gray-100">
